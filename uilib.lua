...
api["CreateMainWindow"] = function()
	...
	local button = settingswheel:Clone()
	...
	discordbutton.MouseButton1Click:connect(function()
		...
		spawn(function()
			local hover3textsize = game:GetService("TextService"):GetTextSize("My discord ID Set to your clipboard!!", 16, Enum.Font.SourceSans, Vector2.new(99999, 99999))
			...
			hoverbox3.Text = "My Discord ID set to your clipboard!!"
			hoverbox3.ZIndex = 5
